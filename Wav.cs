...
namespace Kaitai
{
    ...
    /// </remarks>
    public partial class Wav : Riff
    {
        public new static Wav FromFile(string fileName)
        {
        ...
        private void _read()
        {
            _chunk = new Riff.ChunkClass(m_io, this, m_root);
        }
        ...
        public partial class InfoChunkType : KaitaiStruct
        {
            ...
            private Riff.ChunkClass _chunk;
            private Wav m_root;
            private Wav.ListChunkType m_parent;
            public Riff.ChunkClass Chunk { get { return _chunk; } }
            public Wav M_Root { get { return m_root; } }
        ...
        public partial class ListChunkType : KaitaiStruct
        {
            ...
            private void _read()
            {
                _parentChunkData = new Riff.ParentChunkDataClass(m_io, this, m_root);
            }
            ...
            private Riff.ParentChunkDataClass _parentChunkData;
            private Wav m_root;
            private Wav.ChunkType m_parent;
            public Riff.ParentChunkDataClass ParentChunkData { get { return _parentChunkData; } }
            public Wav M_Root { get { return m_root; } }
            public Wav.ChunkType M_Parent { get { return m_parent; } }
        }
        ...
        public new List<ChunkType> Subchunks
        {
            get
            {
                if (f_subchunks)
        ...
        private Riff.ParentChunkDataClass _parentChunkData;
        public new Riff.ParentChunkDataClass ParentChunkData
        {
            get
            {
                ...
                if (IsRiffChunk) {
                    ...
                    long _pos = io.Pos;
                    io.Seek(0);
                    _parentChunkData = new Riff.ParentChunkDataClass(io, this, m_root);
                    io.Seek(_pos);
        ...
        private Wav m_root;
        private KaitaiStruct m_parent;
        public new Riff.ChunkClass Chunk { get { return _chunk; } }
        public new Wav M_Root { get { return m_root; } }
        public new KaitaiStruct M_Parent { get { return m_parent; } }
    }
}
